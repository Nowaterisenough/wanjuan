...
class TestParagraphRuleMigration {
    ...
    fun paragraphRulesUseWanjuanDatabaseVersionAndSchema() {
        ...
        assertTrue(repoFile("app/schemas/io.wanjuan.app.data.AppDatabase/95.json").isFile)
        assertFalse(File(repoRoot(), "app/schemas/io.legado.app.data.AppDatabase/95.json").exists())
    }
