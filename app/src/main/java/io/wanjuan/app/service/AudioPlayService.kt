...
import io.wanjuan.app.help.MediaHelp
...
import io.wanjuan.app.model.analyzeRule.AnalyzeUrl.Companion.getMediaItem
import io.wanjuan.app.receiver.MediaButtonReceiver
import io.wanjuan.app.ui.book.audio.AudioPlayActivity
import io.wanjuan.app.utils.activityPendingIntent
import io.wanjuan.app.utils.broadcastPendingIntent
...
class AudioPlayService : BaseService(),
    ...
    private val wakeLock by lazy {
        powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "wanjuan:AudioPlayService")
            .apply {
    ...
    private val wifiLock by lazy {
        ...
        wifiManager?.createWifiLock(WIFI_MODE_FULL_HIGH_PERF, "wanjuan:AudioPlayService")?.apply {
