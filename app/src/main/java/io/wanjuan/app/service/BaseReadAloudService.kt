...
import io.wanjuan.app.lib.permission.Permissions
...
import io.wanjuan.app.utils.observeSharedPreferences
...
abstract class BaseReadAloudService : BaseService(),
    ...
    private val wakeLock by lazy {
        powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "wanjuan:ReadAloudService")
            .apply {
    ...
    private val wifiLock by lazy {
        ...
        wifiManager?.createWifiLock(WifiManager.WIFI_MODE_FULL_HIGH_PERF, "wanjuan:AudioPlayService")
            ?.apply {
