...
import io.wanjuan.app.utils.startForegroundServiceCompat
import io.wanjuan.app.utils.startService
import io.wanjuan.app.utils.stopService
import io.wanjuan.app.utils.toastOnUi
import io.wanjuan.app.web.HttpServer
import io.wanjuan.app.web.WebSocketServer
...
class WebService : BaseService() {
    ...
    private val wakeLock: PowerManager.WakeLock by lazy {
        powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "wanjuan:WebService")
            .apply {
    ...
    private val wifiLock by lazy {
        ...
        wifiManager?.createWifiLock(WifiManager.WIFI_MODE_FULL_HIGH_PERF, "wanjuan:WebService")
            ?.apply {
                setReferenceCounted(false)
            }
    }
