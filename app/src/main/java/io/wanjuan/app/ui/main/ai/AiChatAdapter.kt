package io.wanjuan.app.ui.main.ai
...
import io.wanjuan.app.databinding.ItemAiMessageAssistantBinding
import io.wanjuan.app.databinding.ItemAiMessageUserBinding
...
import io.wanjuan.app.ui.widget.image.CoverImageView
...
class AiChatAdapter(
    ...
    private companion object {
        ...
        const val searchBookScheme = "wanjuan-search-book://"
        val toolEventBlockRegex = Regex(
            "```wanjuan-tool-events\\s*\\n([\\s\\S]*?)\\n```",
            setOf(RegexOption.MULTILINE)
        )
        val searchResultBlockRegex = Regex(
            "```wanjuan-search-results\\s*\\n([\\s\\S]*?)\\n```",
            setOf(RegexOption.MULTILINE)
        )
    }
}
