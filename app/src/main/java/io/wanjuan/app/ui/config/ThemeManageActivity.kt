...
import io.wanjuan.app.databinding.ActivityThemeManageBinding
import io.wanjuan.app.databinding.DialogImageBlurringBinding
import io.wanjuan.app.databinding.DialogThemePackageEditBinding
import io.wanjuan.app.databinding.ItemThemePackageOptionBinding
import io.wanjuan.app.databinding.ItemThemePackageBinding
...
class ThemeManageActivity : BaseActivity<ActivityThemeManageBinding>(),
    ...
    private fun loadThemes() {
        ...
        binding.tvSummary.text = getString(R.string.theme_package_summary_default)
        lifecycleScope.launch {
            kotlin.runCatching {
                ...
                if (version != loadVersion) return@launch
                binding.tvSummary.text = getString(R.string.theme_package_load_failed, it.localizedMessage)
            }
        }
    }
