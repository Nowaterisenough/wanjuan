...
import io.wanjuan.app.databinding.DialogBookshelfConfigBinding
...
import io.wanjuan.app.ui.book.cache.CacheActivity
import io.wanjuan.app.ui.book.group.GroupManageDialog
import io.wanjuan.app.ui.book.import.local.ImportBookActivity
import io.wanjuan.app.ui.book.import.remote.RemoteBookActivity
import io.wanjuan.app.ui.book.manage.BookshelfManageActivity
...
import io.wanjuan.app.utils.getCheckedIndex
...
abstract class BaseBookshelfFragment(layoutId: Int) : VMBaseFragment<BookshelfViewModel>(layoutId),
    ...
    protected open fun currentUpdateBooks(): List<Book> = books
    ...
    override fun onCompatOptionsItemSelected(item: MenuItem) {
        ...
        when (item.itemId) {
            ...
            R.id.menu_update_toc -> activityViewModel.upToc(currentUpdateBooks(), onlyUpdateRead)
