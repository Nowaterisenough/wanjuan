...
import io.wanjuan.app.databinding.ViewDetailSeekBarBinding
...
import io.wanjuan.app.utils.progressAdd
...
class DetailSeekBar @JvmOverloads constructor(
    ...
    var onChanging: ((progress: Int) -> Unit)? = null
