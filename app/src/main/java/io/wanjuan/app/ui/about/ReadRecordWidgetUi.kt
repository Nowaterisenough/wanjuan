...
import io.wanjuan.app.databinding.ItemReadRecordCoverBinding
import io.wanjuan.app.databinding.ItemReadRecordRankBinding
...
fun Context.openReadRecordBook(
    book: io.wanjuan.app.data.entities.Book?,
