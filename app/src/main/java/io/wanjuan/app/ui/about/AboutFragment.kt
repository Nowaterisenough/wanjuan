...
import io.wanjuan.app.help.update.AppUpdate
import io.wanjuan.app.help.update.AppUpdateGitHub
...
import io.wanjuan.app.utils.createFolderIfNotExist
...
import io.wanjuan.app.utils.sendMail
...
class AboutFragment : PreferenceFragmentCompat() {
    ...
    override fun onPreferenceTreeClick(preference: Preference): Boolean {
        when (preference.key) {
            ...
            "gzGzh" -> requireContext().sendToClip(getString(R.string.wanjuan_gzh))
