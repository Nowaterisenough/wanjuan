...
package io.wanjuan.app.ui.widget.code
...
val wanjuanPattern: Pattern = Pattern.compile("\\|\\||&&|%%|@js:|@Json:|@css:|@@|@XPath:|@webjs:")
...
fun CodeView.addWanjuanPattern() {
    addSyntaxPattern(wanjuanPattern, appCtx.color(R.color.md_orange_900))
}
