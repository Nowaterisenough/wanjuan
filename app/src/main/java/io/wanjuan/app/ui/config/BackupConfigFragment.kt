...
import io.wanjuan.app.help.storage.BackupConfig
import io.wanjuan.app.help.storage.ImportOldData
...
import io.wanjuan.app.utils.toEditable
...
class BackupConfigFragment : PreferenceFragment(),
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<io.wanjuan.app.lib.prefs.Preference>("web_dav_restore")
            ?.onLongClick {
                restoreFromLocal()
                true
            }
