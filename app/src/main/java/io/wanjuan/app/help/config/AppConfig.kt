...
import io.wanjuan.app.utils.putPrefLong
...
import io.wanjuan.app.utils.sysConfiguration
import io.wanjuan.app.utils.toastOnUi
import io.wanjuan.app.ui.main.ai.AiChatSession
import io.wanjuan.app.ui.main.ai.AiMcpServerConfig
import io.wanjuan.app.ui.main.ai.AiModelConfig
import io.wanjuan.app.ui.main.ai.AiProviderConfig
import io.wanjuan.app.ui.main.ai.AiSkillConfig
import io.wanjuan.app.ui.book.read.ReadAiBookHistory
                ...
                .map { session ->
                    session.copy(
                        messages = session.messages.map { message ->
                            message.copy(
                                kind = message.kind ?: io.wanjuan.app.ui.main.ai.AiChatMessage.Kind.TEXT,
                    ...
                    for (index in 0 until array.length()) {
                        ...
                        val sessions = buildList {
                            for (recordIndex in 0 until records.length()) {
                                ...
                                add(
                                    io.wanjuan.app.ui.book.read.ReadAiSession(
                                        ...
                                        updatedAt = createdAt,
                                        messages = listOf(
                                            io.wanjuan.app.ui.book.read.ReadAiMessage(
                                                role = io.wanjuan.app.ui.book.read.ReadAiMessage.Role.USER,
                                                content = question,
                                                createdAt = createdAt
                                            ),
                                            io.wanjuan.app.ui.book.read.ReadAiMessage(
                                                role = io.wanjuan.app.ui.book.read.ReadAiMessage.Role.ASSISTANT,
                                                content = answer,
                                                createdAt = createdAt
                                            )
                                        )
