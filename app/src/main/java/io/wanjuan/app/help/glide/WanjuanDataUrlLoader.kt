...
import io.wanjuan.app.utils.ImageUtils
import com.script.rhino.runScriptWithContext
import kotlinx.coroutines.Job
import java.io.InputStream

class WanjuanDataUrlLoader : ModelLoader<String, InputStream> {
    ...
    override fun buildLoadData(
        ...
        return ModelLoader.LoadData(ObjectKey(model), WanjuanDataUrlFetcher(model))
    }
    ...
    class WanjuanDataUrlFetcher(private val model: String) : DataFetcher<InputStream> {
