...
class HttpTest {
    ...
    private fun webViewDownloadTest() {
        runOnUI {
            ...
            webView.loadUrl("https://gj.wanjuan.cc/wanjuan/?url=https://miaogongzi.lanzout.com/iITmP0s7y26d&type=down")
        }
    }
    ...
    private fun downloadManagerTest() {
        runBlocking {
            val request =
                DownloadManager.Request(Uri.parse("https://gj.wanjuan.cc/wanjuan/?url=https://miaogongzi.lanzout.com/iITmP0s7y26d&type=down"))
            // 设置通知
