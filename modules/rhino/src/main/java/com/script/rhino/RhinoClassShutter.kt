...
object RhinoClassShutter : ClassShutter {
    ...
    private val protectedClassNamesMatcher by lazy {
        listOf(
            ...
            "io.wanjuan.app.data.AppDatabase",
            "io.wanjuan.app.data.AppDatabase_Impl",
            "io.wanjuan.app.data.AppDatabaseKt",
            "io.wanjuan.app.utils.ContextExtensionsKt",
