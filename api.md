...
请求BODY内容为`JSON`字符串，  
格式参考[这个文件](/app/src/main/java/io/wanjuan/app/data/entities/BookSource.kt)
...
请求BODY内容为`JSON`字符串，  
格式参考[这个文件](/app/src/main/java/io/wanjuan/app/data/entities/BookSource.kt)，**为数组格式**。
...
请求BODY内容为`JSON`字符串，  
替换规则参考[这个文件](/app/src/main/java/io/wanjuan/app/data/entities/ReplaceRule.kt)。
...
请求BODY内容为`JSON`字符串，  
格式参考[这个文件](/app/src/main/java/io/wanjuan/app/data/entities/Book.kt)。
...
请求BODY内容为`JSON`字符串，  
格式参考[这个文件](/app/src/main/java/io/wanjuan/app/data/entities/BookProgress.kt)。
...
### [Content Provider](/app/src/main/java/io/wanjuan/app/api/ReaderProvider.kt)


* 需声明`io.wanjuan.READ_WRITE`权限
* `providerHost`为`包名.readerProvider`, 如`io.wanjuan.app.release.readerProvider`,不同包的地址不同,防止冲突安装失败
